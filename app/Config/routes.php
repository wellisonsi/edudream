 ...
 */
	...
	Router::connect('/conquista', array('controller' => 'pages', 'action' => 'conquista'));
	Router::connect('/bitcoins', array('controller' => 'pages', 'action' => 'bitcoins'));
	Router::connect('/recebimento/*', array('controller' => 'pages', 'action' => 'recebimento'));
